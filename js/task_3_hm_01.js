...
if (userPassword === 'jqueryismyjam' && ADMIN_PASSWORD === 'jqueryismyjam') {
  console.log((message = ACCESS_IS_ALLOWED));
} else if (userPassword === null && ADMIN_PASSWORD === 'jqueryismyjam') {
  console.log((message = CANCELED_BY_USER));
} else {
  console.log((message = ACCESS_DENIED));
}

//---------------------------------------------------------------------------------- the end of third task-------------------------------------------------------------------
